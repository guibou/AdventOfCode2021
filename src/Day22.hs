-- start 10:33
-- first start 10:50
-- second star 20:19 (yes, I did my office day ;)
module Day22 where
...
intersectRange (Range a b) (Range a' b') = toRange (max a a') (min b b')
...
test = do
  describe "simple examples" $ do
    ...
    it "of second star" $ do
      day' largeEx `shouldBe` 2758514936282235
  describe "works" $ do
    it "on first star" $ do
      day fileContent `shouldBe` 556501
    it "on second star" $ do
      day' fileContent `shouldBe` 1217140271559773
